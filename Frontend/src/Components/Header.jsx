...
const Header = () => {
  ...
  // className={`${isMobileMenuOpen ? 'block' : 'hidden'} justify-between items-center w-full lg:flex lg:w-auto `}
  return (
    <header>
      <nav className="bg-white border-gray-200 px-4 lg:px-6 py-2.5 border border-b-1">
        <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
          ...
          <div className={`${isMobileMenuOpen ? 'block' : 'hidden'} justify-between items-center w-full lg:flex lg:w-auto gap-10 lg:order-1`} id="mobile-menu-2">
