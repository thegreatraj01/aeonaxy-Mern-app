            ...
            <div className='w-1/2 mt-6 mx-auto'>
                ...
                <form>
                    ...
                    <div className="mb-4">
                        ...
                        <input type="text" placeholder="Enter a location" className="w-full px-3 py-2 border-b border-gray-300 shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm md:w-full" />
                    </div>
