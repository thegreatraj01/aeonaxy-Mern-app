                    ...
                    {({ setFieldValue }) => (
                        <Form>
                                ...
                                <div className="flex justify-start flex-col lg:flex-row">
                                    <label htmlFor="avatar-upload" className="flex flex-col items-center justify-center border-2 border-gray-300 border-dashed cursor-pointer hover:bg-gray-100 rounded-full w-36 h-36 bg-white text-white">
                                        <div className="flex justify-center items-center">
                                            ...
                                            <Field id="avatar-upload" name="avatar" type="file" className="hidden" onChange={(event) => setFieldValue("avatar", event.currentTarget.files[0])} />
                                        </div>
                                    </label>
                            ...
                            <div className="mb-4">
                                ...
                                <Field type="text" name="location" placeholder="Enter a location" className="w-full px-3 py-2 border-b border-gray-300 shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm md:w-full" />
                            </div>
